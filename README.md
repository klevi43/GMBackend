# Welcome!
This is the backend for Growth Mindset, a REST API that allows a user to log their workouts. Built using Java 17, Spring Boot, Hibernate, JPA, Blaze Persistence, and Maven, this app provides a robust backend solution for anyone who wants to keep a record of their completed workouts so that they can more effectively track their progess in the gym. 
